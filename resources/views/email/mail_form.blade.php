...
<form action="{{ route('send.mail') }}" method="POST" class="space-y-5">
    @csrf

    <div>
        <label for="email" class="block text-gray-700 font-medium mb-1">Кому:</label>
    ...
    <div>
        <label for="message" class="block text-gray-700 font-medium mb-1">Текст письма:</label>
